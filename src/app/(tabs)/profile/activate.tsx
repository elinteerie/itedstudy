...
export default function ActivateAppScreen() {
    ...
    const handleActivate = () => {
        console.log('Activate:', activationCode);
    };
    ...
    <View style={[styles.smallRectangle, {width: 18}]} />
                    ...
                    <View style={styles.bankDetails}>
                        ...
                        <View style={styles.detailRow}>
                            ...
                            <Text style={styles.detailValue}>N2500</Text>
                        </View>
                        <View style={styles.detailRow}>
                            <Text style={styles.detailLabel}>Bank Name:</Text>
                            <Text style={styles.detailValue}>Opay</Text>
                        </View>
                        <View style={styles.detailRow}>
                            <Text style={styles.detailLabel}>Account Number:</Text>
                            <Text style={styles.detailValue}>8188604438</Text>
                        </View>
                        <View style={styles.detailRow}>
                            <Text style={styles.detailLabel}>Account Name:</Text>
                            <Text style={styles.detailValue}>Ited Edu</Text>
                        </View>
                    </View>
                </View>
            </ScrollView>
