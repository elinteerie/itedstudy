...
const PastQuestions = () => {
    ...
    const handleSelectAnswer = (questionId: number, optionIndex: number): void => {
    ...
    const handleShowAnswer = (questionId: number): void => {
        setShowAnswers((prev: ShowAnswers) => ({
            ...prev,
            [questionId]: true,
        }));
    };
                        ...
                        {q.options.map((option, oIndex) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <Text style={[
                                        styles.optionText,
                                        (isSelected || showCorrect) && styles.selectedText,
                                    ]}>
                                        {option}
                                    </Text>
                                </TouchableOpacity>
